...
// Variables
    tag1       = $('.pl__all'),
    tag2       = $('.place_your_tag_name_here1'),
    tag3       = $('.place_your_tag_name_here2'),
    tag4       = $('.place_your_tag_name_here3'),
    tag5       = $('.place_your_tag_name_here4'),
    tag6       = $('.place_your_tag_name_here5');
var sidebar    = $('#sidebar'),
    container  = $('#post'),
    content    = $('#pjax'),
    button     = $('#icon-arrow');
